...
from common.requests_util import DEEPL, POND


def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Python client to translate texts using deepl.com and pond.com"
    )
    ...
    parser.add_argument("translator_type", help="번역기 타입 deepl or pond", choices=[DEEPL, POND])
...
def main():
    ...
    try:
        ...
        if translator_type == DEEPL:
            ...
            print(pond.translate(source_language, target_language, text, **kwargs))
